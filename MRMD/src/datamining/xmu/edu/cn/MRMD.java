...
public class MRMD {
	...
	public static void main(String[] args) throws Exception, Exception{
		...
		String x="-i D://bupa.arff -o D://gjs.arff -sn 5 -ln 2 -df 1 -a D://d.arff";
		args = x.split(" ");
		...
		{
			System.out.println("\r\nThe file  is empty !!\r\n");
			//System.out.println("Usage: java -jar MRMD.jar -i inputFile -o outputFile -in insNum -fn feaNum -sn seleFeaNum -ln lableNum -df disFunc -a arff");
			System.exit(0);
		}
